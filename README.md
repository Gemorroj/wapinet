...
# 7zip
cd /opt
mkdir 7z2602-linux-x64
cd /opt/7z2602-linux-x64
curl -O -L https://7-zip.org/a/7z2602-linux-x64.tar.xz
tar xJvf 7z2602-linux-x64.tar.xz
rm -f 7z2602-linux-x64.tar.xz
/opt/7z2602-linux-x64/7zz i
