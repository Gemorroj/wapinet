...
# 7zip
cd /opt
mkdir 7z2501-linux-x64
cd /opt/7z2501-linux-x64
curl -O -L https://7-zip.org/a/7z2501-linux-x64.tar.xz
tar xJvf 7z2501-linux-x64.tar.xz
