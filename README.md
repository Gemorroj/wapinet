...
# 7zip
cd /opt
mkdir 7z2603-linux-x64
cd /opt/7z2603-linux-x64
curl -O -L https://7-zip.org/a/7z2603-linux-x64.tar.xz
tar xJvf 7z2603-linux-x64.tar.xz
rm -f 7z2603-linux-x64.tar.xz
/opt/7z2603-linux-x64/7zz i

# ffmpeg - https://ubuntuhandbook.org/index.php/2024/04/ffmpeg-7-0-ppa-ubuntu/
add-apt-repository ppa:ubuntuhandbook1/ffmpeg9
apt install ffmpeg
```
