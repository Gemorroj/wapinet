...
- Удалять неиспользуемые тэги и пересчитывать кол-во их использования при удалении файлов.
- Подсказывать тэги через подгрузку через ajax при добавлении файла.
